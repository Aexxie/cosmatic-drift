using Content.Client._CD.Calendar;
...
namespace Content.Client.PDA
{
    ...
    public sealed partial class PdaMenu : PdaWindow
    {
        ...
        private readonly CalendarSystem _cal = new(); // CD Addition
        ...
        private string _universalDate = Loc.GetString("comp-pda-ui-unknown");
        ...
        public PdaMenu()
        {
            ...
            // CD Addition
            UniversalTimeButton.OnPressed += _ =>
            {
                _clipboard.SetText(_universalDate);
            };
        ...
        public void UpdateState(PdaUpdateState state)
        {
            ...
            // CD Additions
            var daysInYear = _cfg.GetCVar(CDCCVars.DaysPerYear);
            var daysInMonth = _cfg.GetCVar(CDCCVars.DaysPerMonth);
            var daysInWeek = _cfg.GetCVar(CDCCVars.DaysPerWeek);

            var universalCalendar = _cal.FormatDate(daysInYear, daysInMonth, daysInWeek, _gameTicker.UniversalCalendar);

            _universalDate = Loc.GetString("comp-pda-ui-universal-time", ("time", universalCalendar));
            UniversalTimeLabel.SetMarkup(_universalDate);
